...
const ALBUMS = {
  ...
  "Just Visiting": {
    year: "2006",
    cover: "images/album-cover-just-visiting.png",
  },
};
...
const TRACKS = [
  ...
  { title: "Sink or Swim", album: "Discounted Lucky Stars", src: "audio/track-19-sink-or-swim.mp3" },
  ...
  { title: "We Are Change", album: "Seventeen Minute Hole", src: "audio/track-04-we-are-change.mp3" },
  ...
  { title: "The Evening", album: "Just Visiting", src: "audio/track-06-the-evening.mp3" },
  { title: "Test Run", album: "Just Visiting", src: "audio/track-20-test-run.mp3" },
  { title: "Any Time You Like", album: "Just Visiting", src: "audio/track-01-any-time-you-like.mp3" },
